      ...
      <div class="container">
        ...
        <div class="row align-items-center">
          <div class="col-12 col-md-6 text-center">
            <img src="static/img/about-me-img.jpg" title="Morgan" alt="Morgan" />
          </div>
    ...
    <section id="portfolio" class="section p-b-0px">
        ...
        <div id="portfolio-slider-single" class="owl-carousel">
            <div class="portfolio-col">
              <img src="static/img/project-1.jpg" title="Morgan" alt="Morgan" />
              <div class="bg-theme">
                <a href="#"></a>
              </div>
              <div class="hover">
            ...
            <!-- col -->
            <div class="portfolio-col">
              <img src="static/img/project-2.jpg" title="Morgan" alt="Morgan" />
              <div class="bg-theme">
                <a href="#"></a>
              </div>
              <div class="hover">
            ...
            <!-- col -->
            <div class="portfolio-col">
              <img src="static/img/project-3.jpg" title="Morgan" alt="Morgan" />
              <div class="bg-theme">
                <a href="#"></a>
              </div>
              <div class="hover">
            ...
            <!-- col -->
            <div class="portfolio-col">
              <img src="static/img/project-4.jpg" title="Morgan" alt="Morgan" />
              <div class="bg-theme">
                <a href="#"></a>
              </div>
              <div class="hover">
          ...
          <div class="col-md-6">
              <div id="client-slider-single" class="owl-carousel">
                <div class="testimonial-col text-center">
                    <div class="img">
                      <img src="static/img/avtar3.jpg" alt="Morgan" title="Morgan" />
                    </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-12 col-md-4">
            <div class="blog-item">
              <a href="#">
                <img src="static/img/blog-img4.jpg" title="Morgan" alt="Morgan" />
              </a>
          ...
          <div class="col-12 col-md-4">
            <div class="blog-item">
              <a href="#">
                <img src="static/img/blog-img3.jpg" title="Morgan" alt="Morgan" />
              </a>
              <div class="blog-content">
                <div class="post-meta">
                  By <a href="">John Doe</a> <span>03.02.2018</span>
          ...
          <div class="col-12 col-md-4">
            <div class="blog-item">
              <a href="#">
                <img src="static/img/blog-img2.jpg" title="Morgan" alt="Morgan" />
              </a>
              <div class="blog-content">
                <div class="post-meta">
                  By <a href="">John Doe</a> <span>03.02.2018</span>
